...
public class Mastermind
{
    ...
    public static void Main()
    {
        ...
        try
        {
            do
            {
                ...
                // If the player enters smaller or larger input.
                ...
                if (randomnumber == input)
                {
                    ...
                    Console.WriteLine($" Congratulations, you won! You guessed the number in {run + 1} attempts!");
                    break;
                }
            ...
            // If the player is unable to input the correct value after 10 attempts.
    ...
    // Conditions for giving responses/hints to the player on every input.
